  ...
  for i:= 1 to 200000 do 
    begin 
      ...
      begin 
        ...
        Vy:=round(i/55); 
        Vx:=round(i/270); 
        y1:=-((goruzont-200+Vy+g)-580)+399; 
        y2:=-((goruzont-200+Vy+g)-600)+399; 
        brush(1,73, 237, 82); 
        pen(1,0, 0, 0); 
        ...
        if y2=600 then 
        begin
        for k:=0 to 222222 do
        begin
        g:=round(-sqr(k/2600)); 
        Vy:=round(k/55); 
        Vx:=round((i/270)+k/280); 
        y1:=-((goruzont-200+Vy+g)-580)+400; 
        y2:=-((goruzont-200+Vy+g)-600)+400; 
        brush(1,73, 237, 82); 
        pen(1,0, 0, 0); 
        ellipse(10+Vx,y1,30+Vx,y2); 
        moveto(20,500); 
