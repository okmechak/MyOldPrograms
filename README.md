# MyOldPrograms/МоїСтаріПрограми
...
Цей репозиторій має для мене велику історичну цінність. Програми які тут знаходяться мали величезний вплив на мене і ехо з тих часів, можна чути ще досі. Наприклад те, що я зараз вчуся на компютерній фізиці і намагаюсь присвятити цьому напрямку увесь свій час. Надалі намагатимусь описати передумови і деталі, щодо програм, а також спробую поділитися тею радістю, яку відчував, коли їх писав і духом відкриттів ;)

В цьому репозиторії знаходяться, також програми-тренування, які писав набагато пізніше будучи на роботі. Але їх ми поминемо. Ось вони вже зовсім не цікаві.
...
[вихідний код](AlgoPrograms/13-D!.pas)
...
[вихідний код](AlgoPrograms/cRYTUCYB.pas)

І ще один приклад:

![3D паралелепіпед](Images/3-Dparalelepiped.gif)

[вихідний код](AlgoPrograms/3-dparalelepiped.pas)
...
[вихідний код](AlgoPrograms/hypercub.pas)
...
[вихідний код](AlgoPrograms/rotaterectangle.pas)
...
[вихідний код](AlgoPrograms/15EXPER.pas)
...
[посилання на програму](AlgoPrograms/3DGeometry-Delphi/Project1.exe)
...
[вихідний код](AlgoPrograms/lasten2.pas)
...
[вихідний код](AlgoPrograms/linebo.pas)

![Мячика і похила поверхня 2](Images/kulka.jpg)

[вихідний код](AlgoPrograms/kulka.pas)

![Мячика і похила поверхня 3](Images/kulka2.gif)

[вихідний код](AlgoPrograms/kulka2.pas)
...
[вихідний код](AlgoPrograms/Vidbuttia.pas)
...
[вихідний код](AlgoPrograms/Law/FTertiaended.pas)
...
[вихідний код](AlgoPrograms/gravitation.pas)
...
[вихідний код](AlgoPrograms/Fractals/derevo.pas)

### Більярд

![Більярд](Images/BBBBB1.jpg)

[вихідний код](AlgoPrograms/BBBBB1.pas)

### Тести на додавання і віднімання

![Тести на додавання і віднімання](Images/dodavanniaividnimannia.jpg)

[вихідний код](AlgoPrograms/dodavnniaividnimannia.pas)

### Перетворення Ферє

![Перетворення Ферє](Images/furje.jpg)

[вихідний код](AlgoPrograms/furje.pas)

### Крива Безє

![Крива Безє](Images/kryvalinia.gif)

[вихідний код](AlgoPrograms/kruvalinija.pas)

### Теплопровідність

![Теплопровідність](Images/teploprovidnist.jpg)

[вихідний код](AlgoPrograms/teploprovidnist.pas)

### Аеросила крила

![Аеросила крила](Images/aerosulacryla.jpg)

[вихідний код](AlgoPrograms/aerosulacrula.pas)

### Тригонометрія

![Тригонометрія](Images/trygonometria.jpg)

[вихідний код](AlgoPrograms/trugonometria.pas)

### Комплексні числа

![Комплексні числа](Images/complexmasive.jpg)

[вихідний код](AlgoPrograms/coplexmassive.pas)
